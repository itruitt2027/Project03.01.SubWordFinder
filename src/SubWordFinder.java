...
/**
 * SubWordFinder finds words in a given file and parses them to create the subwords inside the root word.
...
public class SubWordFinder implements WordFinder {
    ...
    /**
     * The binarySearch method is a search method that uses a compare system to find the target.
     * @param list
     * @param low
     * @param high
     * @param target
    ...
    /**
     * Main compiles the methods with the addition of some print statements to print out the parsed words from the new_scrabble.txt file
     * @param args
     */
    public static void main(String[] args) {
        SubWordFinder app = new SubWordFinder();
        ArrayList<SubWord> subwords = app.getSubWords();
        System.out.println("* List of SubWord objects in the dictionary *");
